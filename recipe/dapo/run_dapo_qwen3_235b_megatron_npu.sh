...
MCORE_MODEL_PATH=""
CKPTS_DIR=""
TRAIN_FILE="dapo-math-17k-update-reasoning.parquet"
TEST_FILE=""
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    +actor_rollout_ref.actor.megatron.override_transformer_config.num_layers_in_first_pipeline_stage=22 \
    +actor_rollout_ref.actor.megatron.override_transformer_config.num_layers_in_last_pipeline_stage=22 \
