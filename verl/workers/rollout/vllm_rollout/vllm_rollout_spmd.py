...
class vLLMRollout(BaseRollout):
    def __init__(
        ...
        self.inference_engine = LLM(
            ...
            disable_custom_all_reduce=True, #todo 这里可能需要改成 False
        ...
        if os.getenv("LOAD_VALIDATION","0") == "1":
            ...
            if torch.distributed.get_rank()==0:
                ...
                torch.save(dict(tmp_model.model.named_parameters())[tmp_dump_name], f"/mnt/hpfs_test/zy/load_format_dummy/dummy_初始化_{tmp_dump_name}.pt")
        ...
        if peft_config and base_sync_done:
            ...
            if os.getenv("LOAD_VALIDATION","0") == "1":
                ...
                if torch.distributed.get_rank()==0:
                    ...
                    torch.save(dict(model.named_parameters())[tmp_dump_name_2], f"/mnt/hpfs_test/zy/load_format_dummy/resharding_patch前dummy_{tmp_dump_name_2}.pt")
            ...
            if os.getenv("LOAD_VALIDATION","0") == "1":
                if torch.distributed.get_rank()==0:
                    torch.save(dict(model.named_parameters())[tmp_dump_name_2], f"/mnt/hpfs_test/zy/load_format_dummy/resharding_patch后dummy_{tmp_dump_name_2}.pt")
