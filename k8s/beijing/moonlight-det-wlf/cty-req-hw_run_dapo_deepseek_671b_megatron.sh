...
EXP_DIR=/mnt/hpfs/chenyd/verl_req_sched/verl/logs/$(date +%Y%m%d_%H%M%S)
NGPUS_PER_NODES=8
export NNODES=2

export TIMESTAMP=$(date +"%m-%d_%H-%M-%S")
project_name='moonlight'
exp_name='DAPO-MoonLight-16b-megatron-2NODES-det'-${TIMESTAMP}
mkdir -p ./swanlab_logs/${project_name}
export SWANLAB_LOG_DIR=./swanlab_logs/${project_name}/${experiment_name}
...
# Paths
MODEL_PATH=/mnt/hpfs/weights/Moonlight-16B-A3B-Instruct
DIST_CKPT_PATH=/mnt/hpfs/chenyd/verl_req_sched/verl/ckpt

# RAY_DATA_HOME=${RAY_DATA_HOME:-"${HOME}/verl"}
TRAIN_FILE=/mnt/hpfs/chenyd/data/dapo-math-17k_dedup_r1_sys_prompt_mathdapo/train-640.parquet
TEST_FILE=/mnt/hpfs/chenyd/data/dapo-math-17k_dedup_r1_sys_prompt_mathdapo/test-160.parquet
# TRAIN_FILE=/work/share/zjc/verl/datasets/dapo-math-17k_dedup_r1_sys_prompt_mathdapo/train-640.parquet
# TEST_FILE=/work/share/zjc/verl/datasets/dapo-math-17k_dedup_r1_sys_prompt_mathdapo/test-80.parquet
...
export agg=${agg:-mean}
export seq_dir=${seq_dir:-/mnt/hpfs/chenyd/verl_req_sched/verl/seq_log}
export log_dir=${log_dir:-/mnt/hpfs/chenyd/verl_req_sched/verl/seq_log}

# pipeline_num_transformer_layers="[[3],[4],[4],[4],[4],[4],[4],[4],[4],[4],[4],[4],[4],[4],[4],[2]]"
RUNTIME_ENV=/mnt/hpfs/chenyd/verl_req_sched/verl/verl/trainer/mc2_env.yaml
cd /mnt/hpfs/chenyd/verl_req_sched/verl
ray job submit --runtime-env="${RUNTIME_ENV}" \
    -- python3 -m recipe.dapo.main_sched_dapo \
    --config-path=config \
    --config-name="dapo_sched_trainer" \
    ...
    custom_reward_function.path=/mnt/hpfs/chenyd/verl_req_sched/verl/verl/utils/reward_score/math_reward.py \
    ...
    2>&1 | tee /mnt/hpfs/chenyd/verl_req_sched/verl/logs/${exp_name}.log
