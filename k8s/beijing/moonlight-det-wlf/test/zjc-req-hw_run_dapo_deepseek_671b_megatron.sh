...
project_name='test-moonlight-061'
exp_name='test-MoonLight-16b-megatron-1NODES-no-reqsched'
...
# Paths
MODEL_PATH=/work/share/models/Moonlight-16B-A3B-Instruct
DIST_CKPT_PATH=/work/share/zjc/verl/ckpt

# RAY_DATA_HOME=${RAY_DATA_HOME:-"${HOME}/verl"}
TRAIN_FILE=/work/share/zjc/verl/datasets/gsm8k/train.parquet
TEST_FILE=/work/share/zjc/verl/datasets/gsm8k/test.parquet
...
export agg=${agg:-max}
export seq_dir=${seq_dir:-/work/share/zjc/verl/verl_061/logs}
export log_dir=${log_dir:-/work/share/zjc/verl/verl_061/logs}
...
RUNTIME_ENV=/work/share/zjc/verl/verl_061/verl/trainer/mc2_env.yaml
cd /work/share/zjc/verl/verl_061
ray job submit --runtime-env="${RUNTIME_ENV}" \
    ...
    custom_reward_function.path=/work/share/zjc/verl/verl_061/verl/utils/reward_score/math_reward.py \
    ...
    2>&1 | tee /work/share/zjc/verl/verl_061/logs/${exp_name}.log