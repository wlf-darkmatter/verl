...
CKPTS_DIR=/data01/huawei-2025/weight/ckpt-DAPO-DeepSeek-671b-megatron-base-2k12k-gpu-cp
...
ray job submit --runtime-env="${RUNTIME_ENV}" \
    ...
    trainer.rollout_data_dir=/data01/huawei-2025/lq/rollout_data_dir/baseline_gpu_gbs32_vllm010 \
