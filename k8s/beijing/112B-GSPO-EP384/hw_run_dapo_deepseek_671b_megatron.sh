...
# Paths
MODEL_PATH="/data01/huawei-2025/xczhao/weights/pilot/1114/hf"
DIST_CKPT_PATH="/data01/huawei-2025/xczhao/weights/pilot/1114/mcore"
...
COMMON_EP=${COMMON_EP:-64} #* GPU 是 8
