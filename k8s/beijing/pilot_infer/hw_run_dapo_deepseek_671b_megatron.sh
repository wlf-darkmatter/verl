...
project_name='DAPO'
exp_name='DAPO-pilot-4layers-megatron-2NNODES'
...
MCORE_MODEL_PATH="/data01/huawei-2025/xczhao/weights/4layers_pre_mcore"
RAY_DATA_HOME="/opt"
CKPTS_DIR=/data01/huawei-2025/xczhao/CKPT/test1
...
ray job submit --runtime-env="${RUNTIME_ENV}" \
    ...
    actor_rollout_ref.rollout.skip.dump_dir="/data01/huawei-2025/zhy/skip_rollout" \
