...
class MultiLatentAttention(Attention):
    ...
    def forward(
        ...
        *,
        ...
        print(f"In megatron multi_latent_attention {hidden_states.shape=} {key_value_states.shape=}==================", flush=True)
    ...
    def get_query_key_value_tensors(
        ...
        *,
        ...
        def qkv_up_proj_and_rope_apply(q_compressed, kv_compressed, k_pos_emb, rotary_pos_emb):
            ...
            print(f"In megatron multi_latent_attention qkv_up_proj_and_rope_apply {q_pos_emb.shape=} {rotary_pos_emb.shape=}==================", flush=True)
        ...
        if self.recompute_up_proj:
            ...
            print(f"In megatron multi_latent_attention {q_compressed.shape=} {kv_compressed.shape=} {k_pos_emb.shape=} {rotary_pos_emb.shape=}==================", flush=True)
