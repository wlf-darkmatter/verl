...
class EagleProposer:
    ...
    def propose(
        ...
        with set_forward_context(per_layer_attn_metadata,
            ...
            print("\033[33;40m################ 【Vllm Eager Propose】 ################\033[0m")
            ...
            if self.method == "deepseek_mtp":
                print("\033[33;40m################ 【Vllm Eager mtp method】 ################\033[0m")
                last_hidden_states = ret_hidden_states
            else:
                print("\033[33;40m################ 【Vllm Eager】 ################\033[0m")
...
def compute_probs_and_sample_next_token(
    ...
    print("\033[33;40m################ 【Vllm Eager sample_next_token】 ################\033[0m")
