...
EXP_DIR=/home/code/logs/$(date +%Y%m%d_%H%M%S)
NGPUS_PER_NODES=${NPU_PER_NODE}
project_name='moonlight'
exp_name='DAPO-MoonLight-16b-megatron-4NODES-req'
...
#! 记得要换数据集！！！！！！！！！！！！！#! sha256sum: e2e7fb3a44543c62e0bf5b5405dd72f13cc2741ba5aa2d8f81bf27ff4e70eecd
TRAIN_FILE="/data01/huawei-2025/rl_data/dapo-math/gbs128-dapo-math-17k_dedup_r1_sys_prompt_mathdapo_filter_has_correct_answer
.parquet"
TEST_FILE="/data01/huawei-2025/rl_data/dapo-math/gbs128-dapo-math-17k_dedup_r1_sys_prompt_mathdapo_filter_has_correct_answer.
parquet"
...
export agg=${agg:-mean}
export seq_dir=${seq_dir:-/home/code/verl/seq_log}
export log_dir=${log_dir:-/home/code/verl/seq_log}
