...
NPU_PER_NODE=16  # A2 NPU Number
NNODES=4         # example is 4 Nodes
...
cd /opt/verl
python3 /home/new_verl/tests/verl_offline_infer.py \
    ${kwargs[@]} \
    --ray_master_ip=172.16.2.65 \
    --ray_master_port=4567 \
    --ray_dashboard_port=1234 \
    --ray_init \
    -tp $gen_tp \
    -dp $gen_dp \
