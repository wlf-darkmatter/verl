...
export VERL_MEMORY_LOG_DIR="/home/new_verl/tmp/512die_12k_base_1012_tp8dp8_new"
...
export ASCEND_PROCESS_LOG_PATH=/home/new_verl/plog/$(basename $(dirname $0))/1012/${RANK}
