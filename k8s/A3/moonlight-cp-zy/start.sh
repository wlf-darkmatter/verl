...
export MASTER_ADDR=172.16.2.66
export http_proxy=http://172.16.2.65:3128
export https_proxy=http://172.16.2.65:3128
...
pip install /mnt/hpfs_test/wlf/pkg/uvloop-0.21.0-cp310-cp310-manylinux_2_17_aarch64.manylinux2014_aarch64.whl
...
# \cp -r $REAL_HOME_CODE/vllm-ascend/* /opt/vllm-ascend/
# \cp -r $REAL_HOME_CODE/vllm/* /opt/vllm/
bash /opt/verl/k8s/patch/apply_vllm-ascend.sh
...
export ServerPort=7777    # modify according to actual situation
export DashboardPort=9999  # modify according to actual situation
