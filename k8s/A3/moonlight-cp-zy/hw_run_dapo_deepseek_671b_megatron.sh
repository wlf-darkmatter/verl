...
# Paths
# MODEL_PATH=/mnt/hpfs_test/weights/Moonlight-16B-A3B-Instruct-32k-zy-cut
MODEL_PATH=/mnt/hpfs_test/weights/Moonlight-16B-A3B-zy
DIST_CKPT_PATH=/mnt/hpfs_test/huawei-2025/gxj/mcore_dist

CKPTS_DIR=/mnt/hpfs_test/weight/CKPT/ckpt-${exp_name}
...
ray job submit --runtime-env="${RUNTIME_ENV}" \
    ...
    +actor_rollout_ref.actor.megatron.override_transformer_config.tensor_model_parallel_size=${ACTOR_CP} \
