...
export VERL_MEMORY_LOG_DIR="/home/code/tmp/memory/512die_12k_base_sleep2"
...
export ASCEND_PROCESS_LOG_PATH=/home/code/plog/$(basename $(dirname $0))/$(date +"%Y-%m-%d--%H-%M-%S")
